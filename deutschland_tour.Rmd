...
The whole analysis is realized as a 'targets'
[@cit_targets] pipeline.
For general data preprocessing the 'tidyverse' [@cit_tidyverse] is used.
Other used packages will be cited along the way.
...
the gpx file [@cit_httr2] and save it to an temporary file [@cit_fs].

The resulting file is a xml file. Read it in [@cit_xml2]
...
We can now plot the data. To Include an underlying map, 'ggspatial'
[@cit_ggspatial] is used.
